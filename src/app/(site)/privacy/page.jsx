  ...
  return (
    <section className="min-h-screen bg-white text-[#0f2742] overflow-hidden">
      ...
      <div className="px-6 md:px-24 pb-32 max-w-5xl">
        ...
        >
          <p>
            Terms &amp; Conditions This document is an electronic record in
            ...
            https://montoaklyn.vercel.app/ ('Website'), including the related
            mobile site and mobile application (hereinafter referred to as
            'Platform'). The Platform is owned by montoaklyn, a company
            incorporated under the Companies Act, 1956 with its registered
            office at MONT OAKLYN, 225 Vaishnavi Bhavan Pawdhoi Badi Sadak ,
            Haridwar, Uttarakhand, 249407 (hereinafter referred to as ‘Platform
            Owner’, 'we', 'us', 'our').. Your use of the Platform and services
            ...
            context so requires ‘you’, 'your' or ‘user’ shall mean any natural
            or legal person who has agreed to become a user/buyer on the
            Platform.. ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM
          ...
          <p>
            ...
            acts done through the use of your registered account on the
            ...
            or suitability of the information and materials offered on this
            ...
            Terms of Use and/or applicable laws.. You agree to pay us the
            charges associated with availing the Services.. You agree not to use
            the Platform and/ or Services for any purpose that is unlawful,
            illegal or forbidden by these Terms, or Indian or local laws that
            might apply to you. You agree and acknowledge that website and the
            Services may contain links to other third party websites. On
            accessing these links, you will be governed by the terms of use,
            ...
            enforceable contract with the Platform Owner for the Services.. You
            shall indemnify and hold harmless Platform Owner, its affiliates,
            ...
            accordance with the laws of India.. All disputes arising out of or
            ...
            information provided on this website Privacy Policy
          </p>

          <p>
            Introduction This Privacy Policy describes how montoaklyn and its
            affiliates (collectively &quot;montoaklyn, we, our, us&quot;)
            collect, use, share, protect or otherwise process your information/
            personal data through our website https://montoaklyn.vercel.app/
            ...
            email, a call from a person/association claiming to be montoaklyn
            ...
            Officer Insert Name of the Office: Designation: Insert Name and
