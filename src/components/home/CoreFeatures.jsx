    ...
    <section className="bg-white px-4 py-10 space-y-10">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <img
            src={
              activeTab === "women" ? "/img/c4.jpeg" : "/img/halfsleeve.jpeg"
            }
          ...
          <div className="grid grid-rows-2 gap-4">
            <img
              src={activeTab === "women" ? "/img/c1.jpeg" : "/img/core42.jpeg"}
              className="object-cover h-full w-full"
            />

            <img
              src={activeTab === "women" ? "/img/c2.jpeg" : "/img/core52.jpeg"}
              className="object-cover h-full w-full"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4">
          {/* BIG IMAGE */}
          <img
            src={activeTab === "women" ? "/img/c3.jpeg" : "/img/core22.jpeg"}
            className="col-span-2 h-[120px] w-full object-cover"
          />

          {/* SMALL IMAGE 1 */}
          <img
            src={activeTab === "women" ? "/img/c5.jpeg" : "/img/core3.jpeg"}
            className="h-[120px] w-full object-cover"
          />

          {/* SMALL IMAGE 2 */}
          <img
            src={activeTab === "women" ? "/img/c7.jpeg" : "/img/cordyroy.jpeg"}
            className="h-[120px] w-full object-cover"
          />
        </div>
      </div>
